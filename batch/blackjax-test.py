...
# %%
mcmc_samples.get("positions.n8o101a1q")[:,0]

# %%
plt.scatter(mcmc_samples.get("positions.n8o101a1q")[:,0], mcmc_samples.get("positions.n8o101a1q")[:,1])

# %%
for key in mcmc_samples.keys():
    val = mcmc_samples[key]
    if type(val) is not dict:
        print("yes")
    print(mcmc_samples[key])
