...
cropped_err = np.where(cropped_err==0.0, 1e10,cropped_err)
...
axs[0].imshow((cropped_data)**0.125)
axs[1].imshow((telescope.model())**0.125)
...
axs[3].imshow((cropped_data - telescope.model())/cropped_err, cmap='seismic')
