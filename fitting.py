...
def hash_arbitrary_object(obj):
    # Serialize the object to stable bytes
...
def cache_lrs(params, C, cache="cache/lrs"):
    hashname = hash_arbitrary_object(params)

    if not os.path.exists(cache):
        os.makedirs(cache)

    save_path = f"{cache}/{hashname}/"
